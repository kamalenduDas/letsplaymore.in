...
<!-- Form register -->
<form class="my-form" id="my-form" action="../process/user-reg-process.php" method="post">


    <div class="form-row">
      <div class="form-group col-md-6">
        <label for="inputEmail4">NAME</label>
        <input type="text" class="form-control" name="uname" id="inputFname" placeholder="eg:John">
        <p id="ErrorFname" ></p>
      </div>
      <div class="form-group col-md-6">
        <label for="inputEmail4">SURNAME</label>
        <input type="text" class="form-control" name="sname" id="inputSname" placeholder="eg:Doe">
        <p id="ErrorSname" ></p>
      </div>
      <div class="form-group col-md-6">
    ...
    <button type="submit" name="submit" id="btnSubmit" class="btn btn-primary">Register</button>
  </form>
<!-- Form register -->
</div>
