...
<link rel="stylesheet" href="../css/mdb.min.css">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    ...
    <div class="text-center">
     <h1 class="white-text mb-5 mt-4 font-bold"><a class="text-dark font-bold"><strong><?php echo $spt; ?></strong></a><strong> CLUBS NEAR</strong> <a class="text-dark font-bold"><strong><?php echo strtoupper($loc); ?></strong></a></h1>
    </div>
