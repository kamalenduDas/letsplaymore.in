    ...
    <div class="card card-image" style="background-image: url('../images/login-user.jpg');">
        <div class="text-white rgba-stylish-strong py-5 px-5 z-depth-4">
            ...
            <div class="text-center">
                <h3 class="white-text mb-5 mt-4 font-bold"><strong>LOGIN</strong> <a class="green-text font-bold"><strong> EMPLOYEE</strong></a></h3>
            </div>
         <form class="" action="../validation/empl-vldn.php" method="post">
            ...
            <div class="row d-flex align-items-center mb-4">
                ...
                <div class="text-center mb-3 col-md-12">
                    <button name="emplsubmit" type="submit" class="btn btn-success btn-block btn-rounded z-depth-1">Log in</button>
                </div>
                <!--Grid column-->
            </div>
            <!--Grid row-->
    ...
    <div class="container">
        ...
        <div class="row py-3 d-flex align-items-center">
            ...
            <div class="col-md-8 col-lg-9">
                ...
                <!--Copyright-->
                <p class="text-center text-md-left grey-text">© 2017 Copyright: <a href="#"><strong>LetsplayMore.in</strong></a></p>
                <!--/.Copyright-->
