...
<!--/.Carousel Wrapper-->
  ...
  <div class="container" >
    ...
    <form class="form-inline" action="show_training_result.php" method="get" style="padding: 50px;">
...
<!--Footer-->
<footer class="page-footer stylish-color-dark" style=" width: 100%; margin-top: 230px;">
