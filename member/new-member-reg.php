...
<div class="text-center">
  <h3 class="white-text mb-5 mt-4 font-bold"><strong>REGISTER</strong> <a class="text-dark font-bold"><strong> NOW</strong></a></h3>
</div>
<div class="container" style="background-color: #e0e0e0 ; padding: 30px;">

<!-- Form register -->
<form class="my-form" action="../process/mbr-reg-process.php" method="post">


    <div class="form-row">
      <div class="form-group col-md-6">
        <label for="inputEmail4">NAME</label>
        <input type="text" class="form-control" id="inputFname" name="fname" placeholder="eg:John">
        <p id="ErrorFname"></p>

      </div>
      <div class="form-group col-md-6">
        <label for="inputEmail4">SURNAME</label>
        <input type="text" class="form-control" id="inputSname" name="sname" placeholder="eg:Doe">
        <p id="ErrorSname"></p>
      </div>
      <div class="form-group col-md-6">
        <label for="inputEmail4">EMAIL</label>
        <input type="email" class="form-control" id="inputEmail4" name="email" placeholder="eg:abc@xyz.com">
        <p id="ErrorEmail"></p>
      </div>
    ...
    <div class="form-group col-md-6">
        ...
        <input type="password" class="form-control" id="inputPassword5" name="pass" placeholder="at least 6 characters">
    ...
    <div class="form-group">
      <label for="inputClubname">CLUBNAME</label>
      <input type="text" class="form-control" id="inputClubname" name="club" placeholder="eg:abc club">
      <p id="ErrorClub"></p>
    </div>
    <div class="form-group">
      <label for="inputContact">CONTACT</label>
      <input type="text" class="form-control" id="inputContact" name="contact" placeholder="mobile number">
      <p id="ErrorConn"></p>
    </div>
    <div class="form-row">
    </div>
