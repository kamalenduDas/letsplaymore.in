...
<div class="card card-image" style="background-image: url('../images/login-user.jpg');">
    <div class="text-white rgba-stylish-strong py-5 px-5 z-depth-4">
        ...
        <div class="text-center">
            <h3 class="white-text mb-5 mt-4 font-bold"><strong>LOGIN</strong> <a class="green-text font-bold"><strong> MEMBER</strong></a></h3>
        </div>

        <form class="" action="../validation/mbr-vldn.php" method="post">

          <label for="Form-email5">Your email</label>
        <div class="md-form">
            <input type="text" id="Form-email5" class="form-control white-text" name="email" placeholder="Your email">
        </div>
        ...
        <div class="row d-flex align-items-center mb-4">
            ...
            <div class="text-center mb-3 col-md-12">
                <button name="ownersubmit" type="submit" class="btn btn-success btn-block btn-rounded z-depth-1">Log in</button>
            </div>
            <!--Grid column-->
          </form>
        </div>
...
<div class="container">
    ...
    <div class="row text-center text-md-left mt-3 pb-3">
        ...
        <div class="col-md-4 col-lg-3 col-xl-3 mx-auto mt-3">
            ...
            <p><i class="fa fa-home mr-3"></i>Agarpara,Kolkata700109</p>
